...
#LEDs
#set_property PACKAGE_PIN U16 [get_ports {Breceived[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[0]}]
#set_property PACKAGE_PIN E19 [get_ports {Breceived[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[1]}]
#set_property PACKAGE_PIN U19 [get_ports {Breceived[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[2]}]
#set_property PACKAGE_PIN V19 [get_ports {Breceived[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[3]}]
#set_property PACKAGE_PIN W18 [get_ports {Breceived[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[4]}]
#set_property PACKAGE_PIN U15 [get_ports {Breceived[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[5]}]
#set_property PACKAGE_PIN U14 [get_ports {Breceived[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[6]}]
#set_property PACKAGE_PIN V14 [get_ports {Breceived[7]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[7]}]
#set_property PACKAGE_PIN V13 [get_ports {Breceived[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[8]}]
#set_property PACKAGE_PIN V3 [get_ports {Breceived[9]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Breceived[9]}]
...
###Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {DispB[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DispB[0]}]
##Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports {DispB[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {DispB[1]}]
##Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports {DispB[2]}]					
...
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {clr}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {clr}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {ST}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ST}]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {B[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[0]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {B[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[1]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {B[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[2]}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {B[3]}]					
...
#Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {B[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[4]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {B[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[5]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {B[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[6]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {B[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[7]}]
#Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {B[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[8]}]
#Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {B[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {B[9]}]
#Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {A_Attack[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[0]}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {A_Attack[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[1]}]


#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {A_Attack[2]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[2]}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {A_Attack[3]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[3]}]
#Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {A_Attack[4]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[4]}]
#Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {A_Attack[5]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[5]}]
#Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {A_Attack[6]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[6]}]
#Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {A_Attack[7]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[7]}]
#Sch name = XA3_N
set_property PACKAGE_PIN M1 [get_ports {A_Attack[8]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[8]}]
#Sch name = XA4_N
set_property PACKAGE_PIN N1 [get_ports {A_Attack[9]}]				
