...
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {A_Attack[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[0]}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {A_Attack[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[1]}]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {A_Attack[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[2]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {A_Attack[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[3]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {A_Attack[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[4]}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {A_Attack[5]}]					
...
#Pmod Header JC
#Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {A_Attack[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[6]}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {A_Attack[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[7]}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {A_Attack[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {A_Attack[8]}]
#Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {A_Attack[9]}]					
