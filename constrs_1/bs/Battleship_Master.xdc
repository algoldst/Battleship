...
set_property PACKAGE_PIN W3 [get_ports {Aleds[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[10]}]
set_property PACKAGE_PIN U3 [get_ports {Aleds[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[11]}]
set_property PACKAGE_PIN P3 [get_ports {Aleds[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[12]}]
set_property PACKAGE_PIN N3 [get_ports {Aleds[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[13]}]
set_property PACKAGE_PIN P1 [get_ports {Aleds[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[14]}]
set_property PACKAGE_PIN L1 [get_ports {Aleds[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Aleds[15]}]
...
#Pmod Header JA
#Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports {sendClk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sendClk}]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports {MasSlav_A_Attack}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_A_Attack}]
#Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {MasSlav_Sig}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_Sig}]
#Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {SlavMas_B}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SlavMas_B}]
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports {SlavMas_Sig}]					
