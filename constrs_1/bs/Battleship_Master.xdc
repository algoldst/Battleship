...
###Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {SlavMas_B}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SlavMas_B}]
##Sch name = JA9
...
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {MasSlav_A_Attack}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_A_Attack}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {MasSlav_Sig}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_Sig}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {sendClk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sendClk}]
