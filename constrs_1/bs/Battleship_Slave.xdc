...
set_property PACKAGE_PIN A14 [get_ports {clk}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {clk}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {MasSlav_Sig}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_Sig}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {MasSlav_A}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {MasSlav_A}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {SlavMas_B_Attack}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SlavMas_B_Attack}]
#Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {SlavMas_Sig}]					
...
##Sch name = JC2
#set_property PACKAGE_PIN M18 [get_ports {B_Attack[8]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {B_Attack[9]}]
#Sch name = JC3
